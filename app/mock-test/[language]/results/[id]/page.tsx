...
export default function MockTestResultsPage({ params }: { params: { language: string; id: string } }) {
  ...
  // Mock results data
  const resultsData = {
    examTitle: `${getLanguageName(params.language)} Mock Test ${params.id}`,
    date: "2023-06-15",
    overallScore: 6.5,
    sections: [
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="container mx-auto max-w-4xl">
        <div className="flex items-center mb-6">
          ...
          <h1 className="text-2xl font-bold">{getLanguageName(params.language)} imtihon natijalari</h1>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex items-center mb-4 md:mb-0">
                ...
                <div>
                  <h2 className="text-xl font-bold">Umumiy ball</h2>
              ...
              <div className="text-center md:text-right">
                ...
                <div>
                  <Button size="sm" onClick={() => router.push("/mock-test")}>
          ...
          <TabsContent value="overview">
            <Card>
              <CardHeader>
                ...
                <CardDescription>{getLanguageName(params.language)} imtihoni bo'yicha umumiy natijalar</CardDescription>
              </CardHeader>
              <CardContent>
